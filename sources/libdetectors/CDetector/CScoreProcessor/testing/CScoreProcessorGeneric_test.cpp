...
TEST_CASE("CScoreProcessorGeneric works for high snr inputs (q: 64, N: 60)", "[scoreprocgeneric][high]") {
    ...
    CScoreProcessorGeneric * proc = new CScoreProcessorGeneric(pn, N);
...
TEST_CASE("CScoreProcessorGeneric works for low snr inputs (q: 64, N: 60)", "[scoreprocgeneric][low]") {
