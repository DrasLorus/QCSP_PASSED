...
TEST_CASE("CIterativeAdderGeneric works for high snr inputs (q: 64)", "[iterativeaddergeneric][high]") {
    ...
    CIterativeAdderGeneric * proc = new CIterativeAdderGeneric(q);
...
TEST_CASE("CIterativeAdderGeneric works for low snr inputs (q: 64)", "[iterativeaddergeneric][low][q64]") {
