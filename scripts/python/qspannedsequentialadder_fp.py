...
def main():
    ...
    var_names = ['data_input_m10dB_w1_q64_N60_0_n30', 'iter_fcts_m10dB_w1_q64_N60_0_n30']
    ...
    qadder_resfx: NDArray[np.complex64] = np.array([qadder.process(z.value) for z in FIXED_DATA])
    qadderfp_res: NDArray[np.complex64] = np.array([qadderfp.process(z).value for z in FIXED_DATA])
