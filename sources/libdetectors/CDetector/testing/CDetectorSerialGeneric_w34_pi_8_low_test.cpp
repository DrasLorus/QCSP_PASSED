...
TEST_CASE("CDetectorSerialGeneric (L2, float) works for low snr inputs (q: 64, N: 60, w: 34, d: 8)", "[detectorgeneric][low][l2][w34][q64]") {
...
TEST_CASE("CDetectorSerialGeneric (Raw, float) works for low snr inputs (q: 64, N: 60, w: 34, d: 8)", "[detectorgeneric][low][raw][w34][q64]") {
