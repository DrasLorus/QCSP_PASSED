...
TEST_CASE("CDetectorSerialGeneric (L2, float) works for low snr inputs (q: 64, N: 60, w: 1)", "[detectorgeneric][low][l2][w1]") {
...
TEST_CASE("CDetectorSerialGeneric (Raw, float) works for low snr inputs (q: 64, N: 60, w: 1)", "[detectorgeneric][low][raw][w1]") {
